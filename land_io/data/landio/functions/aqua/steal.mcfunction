...
execute if block ~ ~-1 ~ red_concrete_powder at @e[tag=corner] run fill ~ ~ ~ ~29 ~ ~29 light_blue_concrete replace red_concrete
...
execute if block ~ ~-1 ~ orange_concrete_powder at @e[tag=corner] run fill ~ ~ ~ ~29 ~ ~29 light_blue_concrete replace orange_concrete
...
execute if block ~ ~-1 ~ yellow_concrete_powder at @e[tag=corner] run fill ~ ~ ~ ~29 ~ ~29 light_blue_concrete replace yellow_concrete
...
execute if block ~ ~-1 ~ lime_concrete_powder at @e[tag=corner] run fill ~ ~ ~ ~29 ~ ~29 light_blue_concrete replace lime_concrete
...
execute if block ~ ~-1 ~ green_concrete_powder at @e[tag=corner] run fill ~ ~ ~ ~29 ~ ~29 light_blue_concrete replace green_concrete
...
execute if block ~ ~-1 ~ light_blue_concrete_powder at @e[tag=corner] run fill ~ ~ ~ ~29 ~ ~29 light_blue_concrete replace light_blue_concrete
...
execute if block ~ ~-1 ~ blue_concrete_powder at @e[tag=corner] run fill ~ ~ ~ ~29 ~ ~29 light_blue_concrete replace blue_concrete
...
execute if block ~ ~-1 ~ pink_concrete_powder at @e[tag=corner] run fill ~ ~ ~ ~29 ~ ~29 light_blue_concrete replace pink_concrete
