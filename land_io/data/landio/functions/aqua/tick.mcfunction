...
execute as @p[gamemode=adventure, team=aqua] at @s unless block ~ ~-1 ~ air run function landio:aqua/tick_location
execute as @p[gamemode=adventure, team=aqua] at @s if block ~ ~-1 ~ air positioned ~ ~-1 ~ run function landio:aqua/tick_location
