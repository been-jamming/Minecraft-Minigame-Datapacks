...
execute at @e[tag=corner] run fill ~ ~ ~ ~29 ~ ~29 lime_concrete replace lime_concrete_powder
execute at @e[tag=corner] run fill ~ ~-2 ~ ~29 ~-3 ~29 air
execute at @e[tag=corner] run clone ~ ~ ~ ~29 ~ ~29 ~ ~-2 ~ filtered lime_concrete
execute at @e[tag=corner] run clone ~ ~ ~ ~29 ~ ~29 ~ ~-3 ~ filtered lime_concrete
kill @e[tag=lime_last_pos]
execute at @e[tag=lime_update0] unless block ~ ~-2 ~ lime_concrete run function landio:lime/fill0
execute at @e[tag=lime_update1] unless block ~ ~-2 ~ lime_concrete run function landio:lime/fill1
...
kill @e[tag=lime_update0]
kill @e[tag=lime_update1]
